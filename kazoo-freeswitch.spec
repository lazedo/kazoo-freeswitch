...
######################################################################################################################
%package application-channel-move
Summary:    FreeSWITCH mod_channel_move
Group:          System/Libraries
Requires:       %{name} = %{version}-%{release}

%description application-channel-move
A module by Kazoo for moving channels between FreeSWITCH servers

%files application-channel-move
%defattr(-,freeswitch,daemon)
%{MODINSTDIR}/mod_channel_move.so*

######################################################################################################################
# Event Handler Packages
######################################################################################################################
%package event-kazoo
...
Mod Shout is a FreeSWITCH module to allow you to stream audio from MP3s or a shoutcast stream.
